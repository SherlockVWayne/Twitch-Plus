...
import com.twitchplus.entity.ItemType;
...
import com.twitchplus.entity.Game;

import java.util.*;

public class TwitchClient {
    private static final String TOKEN = "YOUR_OWN_TWITCH_TOKEN";
    private static final String CLIENT_ID = "YOUR_OWN_TWITCH_CLIENT_ID";
